...
public class FrestoEventSubQueue extends Thread {
	Logger LOGGER = Logger.getLogger("FrestoEventSubQueue");
	...
	public FrestoEventSubQueue() {
	}

	public FrestoEventSubQueue(ZMQ.Socket receiveSocket) {
